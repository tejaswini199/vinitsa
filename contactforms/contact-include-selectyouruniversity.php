...
.fixed .form-control1 {
	...
	<body>
		...
		<div class="mysql-form" >
			...
			<h3 class="text-center">Quick Contact Form</h3>
			<p>Have a Question? Send A Free Quote.</p>
			</div>
			<!-- <form name="myForm" action="https://dnipro-nmu.com/contact-form/processxyz.php" method="post"  onsubmit="return validateForm();" > -->
				<form name="myForm" action="https://dnipro-nmu.com/contact-form/processxyz.php" method="post" autocomplete="off" accept-charset="utf-8" >

				<div class="form-group">
					
					<input type="text" class="form-control" id="cName" name="cName" required placeholder="Name:" required>
					
				</div>

				<div class="form-group fixed none footer-div" id="bottom-form" style="display: block;">
					<select id="IsdCode1" class="smat-dropdown-botest lato" style="display: block;" onchange="SelectCountry();">
					...
					<input type="text" class="form-control1" id="cMobile" placeholder="Telephone:" name="cMobile" onkeypress="javascript:return isNumber(event)" value="+91" minlength="11">

				</div>
				<div class="form-group">
					
					<input type="email" class="form-control" id="cEmail" name="cEmail"  required placeholder="Email Address:" required>
					<span class="form-error" id="error-text-email"></span>
				</div>
				<!-- 	<div class="form-group">
				<input type="text" class="form-control" id="cMassege" name="cMassege" placeholder="Enter your Message" required>
				</div> -->
				<div class="form-group">
					
					<!-- <select class="form-control" id="cMassege" name="cMassege">
						<option value="I would like to information about Ukraine" default> information about study MBBS abroad</option>
						<option value="Enquiry regarding Fee Structure">Enquiry regarding Fee Structure</option>
						<option value="Enquiry regarding MBBS in Ukriane ">Enquiry regarding MBBS in Ukriane </option>
					</select> -->
					 <textarea class="form-control" rows="4" id="cMassege" name="cMassege" placeholder="subject:"></textarea> 
				</div>
				<input type="text" name="cWebsite" value="vinnitsa" id="cMassege" hidden/>
				<div class="text-center">
					<input type="submit" name="insert" value="Send Request" class="btn-1" /> 
				</div>
			
				<!-- <label for="labStatus" name="somename"><?php echo $lblStatus; ?></label>-->
			</form>
		</div>
		<div>
</div>
		...
		<script>
			function validateForm() {
				...
				if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
					document.getElementById("error-text-email").innerHTML = "Invalid Email";
					return false;
				}
			}
		</script>
...
<script type="text/javascript">
  ...
  {
    document.getElementById('cMobile').value=document.getElementById('IsdCode1').value;
  }
