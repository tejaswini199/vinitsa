...
if( $conn ) {
  ...
  $cmessage = $_POST['txtMessageValue'];
  $dtdate = date("y-m-d");
  $tsql = "INSERT INTO ContactDetails(cName,cMobile,cEmail,cMassege,cWebsite,dtCreatedDate1) VALUES ('$cname','$cphone','$cemail','$cmessage','vinnitsa-chat','$dtdate')";
